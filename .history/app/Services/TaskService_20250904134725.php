...
class TaskService
{
    ...
    {
        return $this->taskRepository->getAllTasks($workspaceId);
    }
    ...
    {
        return $this->taskRepository->getTasksByStatus($status, $workspaceId);
    }
    ...
    {
        return $this->taskRepository->searchTasks($query, $workspaceId);
    }
    ...
    {
        return $this->taskRepository->getMyTasks($userId);
    }
