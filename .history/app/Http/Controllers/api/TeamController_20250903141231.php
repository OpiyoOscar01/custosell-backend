...
class TeamController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $ledTeams = Team::where('leader_id', $user->id)
            ->with(['workspace', 'leader']);
            
        // Get teams where user is a member via pivot table
        ...
        if ($request->has('workspace_id')) {
            $ledTeams->where('workspace_id', $request->workspace_id);
            $memberTeams->where('workspace_id', $request->workspace_id);
        }
        
        $teams = $ledTeams->get()->merge($memberTeams->get())->unique('id');
